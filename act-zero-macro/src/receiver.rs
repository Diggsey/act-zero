//! Implementation borrowed from `async-trait`.
...
use syn::{
    parse_quote, Error, ExprPath, ExprStruct, Ident, Item, Macro, PatPath, PatStruct,
    PatTupleStruct, Path, PathArguments, QSelf, Receiver, Token, Type, TypePath,
};
